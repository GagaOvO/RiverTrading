                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <form action="/smallstock_add_to_stock" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card-box">
                                                    ...
                                                    <select class="form-control" value="{ old('smallstock_id') }}" name="smallstock_id">
                                                        <option value="0">Item Code</option>
                                                        @foreach($add_stock AS $value)
                                                    ...
                                                    <div class="form-group m-b-20 {{ $errors->has('total') ? ' has-error' : '' }}"">
                                                        ...
                                                        <input type="text" class="form-control" name="total" placeholder="Total In Stock" required>
