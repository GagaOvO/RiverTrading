            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ol class="breadcrumb">
                            <li>Stocker</a></li>
                            <li style="color:#639ace;">Big Stock</a></li>
                        </ol>
                    </div>
                </div>
                ...
                <button type="button" class="btn btn-primary" style="margin-bottom: 10px;margin-left: 10px;" data-toggle="modal" data-target="#myModal">Upload Bulk Stock</button>
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title"><b>Items In Big Stock</b></h4>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="/update_existing_stock" class="form-horizontal" method="post" enctype="multipart/form-data">
                  {{ csrf_field() }}
