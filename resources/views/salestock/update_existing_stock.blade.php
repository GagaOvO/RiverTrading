                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <form action="/add_to_sale_stock" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="card-box">
                                                    ...
                                                    <div class="form-group m-b-20{{ $errors->has('salestock_id') ? ' has-error' : '' }}">
                                                    <label>Item Code<span class="text-danger">*</span></label>
                                                    <select class="form-control" name="salestock_id" value="{ old('salestock_id') }}" name="salestock_id">
                                                    ...
                                                    <div class="form-group m-b-20 {{ $errors->has('total') ? ' has-error' : '' }}"">
                                                        <label>Total In Stock <span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control" name="total" placeholder="New Quantity In" required>
